...
import program.entidades.Endereco;

public class CPF extends Endereco{
	...
	public CPF(String celular, String fone, String dataNasc, String dataVacina1, Integer resp, String rua,
			String bairro, String cidade, String uf, String complemento, String cep, String num, String cpf) {
		super(celular, fone, dataNasc, dataVacina1, resp, rua, bairro, cidade, uf, complemento, cep, num);
		this.cpf = cpf;
	}
	...
	private String formatarCampo(String pattern, Object value) {
		MaskFormatter mask;
		try {
